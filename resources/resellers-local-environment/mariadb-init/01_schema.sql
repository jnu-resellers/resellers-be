...
CREATE TABLE `MATERIAL_TB_auctions`
(
    `Material_MATERIAL_PK` bigint not null,
    `auctions_AUCTION_PK`  bigint not null unique,
    FOREIGN KEY (`auctions_AUCTION_PK`) REFERENCES `AUCTION_TB` (`AUCTION_PK`),
    FOREIGN KEY (`Material_MATERIAL_PK`) REFERENCES `MATERIAL_TB` (`MATERIAL_PK`)
)
