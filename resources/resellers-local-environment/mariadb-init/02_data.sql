...
VALUES
    (1, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명', '상품이름', 1000, 2, 20, 0),
    (2, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명2', '상품이름2', 2000, 1, 10, 0),
    (3, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명3', '상품이름3', 3000, 1, 30, 0),
    (4, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명3', '상품이름3', 4000, 1, 50, 0);
