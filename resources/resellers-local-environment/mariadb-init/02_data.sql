...
VALUES (1, TIMESTAMPADD(DAY, 7, CURRENT_TIMESTAMP), TIMESTAMPADD(DAY, -1, CURRENT_TIMESTAMP), 5, 10000, 500000, 0, 2, 1),
       (2, TIMESTAMPADD(DAY, 14, CURRENT_TIMESTAMP), TIMESTAMPADD(DAY, -2, CURRENT_TIMESTAMP), 10, 10000, 600000, 0, 2, 2),
       (3, TIMESTAMPADD(DAY, 21, CURRENT_TIMESTAMP), TIMESTAMPADD(DAY, -3, CURRENT_TIMESTAMP), 15, 10000, 700000, 0, 2, 3);
