...
VALUES
    (1, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명', '상품이름', 1000, 2, 20, FALSE),
    (2, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명2', '상품이름2', 2000, 1, 10, FALSE),
    (3, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명3', '상품이름3', 3000, 1, 30, FALSE),
    (4, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), '상품설명3', '상품이름3', 4000, 1, 50, FALSE);

-- Insert materials into MATERIAL_TB
INSERT INTO MATERIAL_TB
VALUES
    (1, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), 'REFRIGERATOR', '010-2293-5028', 1),
    (2, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), 'BOWL', '010-1212-1212', 2),
    (3, TIMESTAMPADD(MINUTE, -30, CURRENT_TIME), TIMESTAMPADD(MINUTE, 30, CURRENT_TIME), 'ICE_MAKER', '010-2293-5028', 1);
