...
VALUES (1, TIMESTAMPADD(WEEK , -12, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 1, 2),
       (2, TIMESTAMPADD(WEEK , -11, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 2, 2),
         (3, TIMESTAMPADD(WEEK , -10, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 3, 2),
         (4, TIMESTAMPADD(WEEK , -9, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 4, 2),
         (5, TIMESTAMPADD(WEEK , -8, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 5, 2),
         (6, TIMESTAMPADD(WEEK , -7, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 6, 2),
         (7, TIMESTAMPADD(WEEK , -6, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 7, 2),
         (8, TIMESTAMPADD(WEEK , -5, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 8, 2),
         (9, TIMESTAMPADD(WEEK , -4, CURRENT_TIMESTAMP), TIMESTAMPADD(MINUTE, 30, CURRENT_TIMESTAMP), 0, 1, 'REFRIGERATOR', 9, 2);
